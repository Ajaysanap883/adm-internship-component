...
import Hr from '../assests/human resources.png';

import Med from '../assests/medical volunteer.png'
import Graphic from '../assests/Graphic Designer.png'
import Marketing from '../assests/marketing.png'
import Anchor from '../assests/anchor.png'
import Video from '../assests/video editor.png';
import Uiux from '../assests/ui-ux designer.png';
// import Project from "./components/Projects";
import React from 'react';
import Csr from '../assests/csr.png'
import Campus from '../assests/campus ambassador.png';
import Charity from '../assests/Graphic Designer.png';
import fullstack from '../assests/full stack developer.png';
import publicrelation from '../assests/public relation.png'
...
<Container>
      ...
      <Card.Img className='card-img' variant="top" src={Hr}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta' >
      <Card.Img variant="top" className='card-img' src={Graphic}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta' >
      <Card.Img variant="top" className='card-img' src={Med}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={Video}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img'src={Uiux}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={Marketing}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={Campus}/>
      <Card.Body>
       ...
       <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={Charity}/>
      <Card.Body>
       ...
       <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={fullstack}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={Anchor}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={publicrelation}/>
      <Card.Body>
        ...
        <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
        <Card className='patta'>
      <Card.Img variant="top" className='card-img' src={Csr}/>
      <Card.Body>
